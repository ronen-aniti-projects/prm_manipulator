...
def main():
    ...
    ax1.scatter(
        ee_goal[0], ee_goal[1], ee_goal[2], c="red", s=100, label="Goal EE", marker="X"
    )
    ...
    for xmin, ymin, zmin, xmax, ymax, zmax in ob.obstacles:
        ...
        faces = [[c[i] for i in f] for f in [[0,1,2,3], [4,5,6,7], [0,1,5,4], [2,3,7,6], [1,2,6,5], [3,0,4,7]]]
        ax2.add_collection3d(Poly3DCollection(faces, facecolors='red', alpha=0.3, edgecolors='k'))
